...
sampler2D_float _CameraDepthTexture;
 //Set up Unity Surface Shader Settings.
	#pragma surface frag_surf CLPBR_Standard addshadow  alpha:fade fullforwardshadows
//The Shader Target defines the maximum capabilites of the shader (Number of math operators, texture reads, etc.)
	#pragma target 3.0
...
IN.screenPos.xy /= IN.screenPos.w;
	float2 uv_SSSSmall_Ripples_Texture = IN.uv_SSSSmall_Ripples_Texture;
	...
	//Generate layers for the Normals channel.
		//Generate Layer: Normal Map2
			//Sample parts of the layer:
				half4 Normal_Map2Normals_Sample2 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSLarge_Ripples_Scale,_SSSLarge_Ripples_Scale)),0)+float3(0,0,_Time.y/6)))) + float3(0.04, 0, 0))*3))+1)/2).rrrr);
				half4 Normal_Map2Normals_Sample3 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSLarge_Ripples_Scale,_SSSLarge_Ripples_Scale)),0)+float3(0,0,_Time.y/6)))) + float3(0, 0.04, 0))*3))+1)/2).rrrr);
				half4 Normal_Map2Normals_Sample1 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSLarge_Ripples_Scale,_SSSLarge_Ripples_Scale)),0)+float3(0,0,_Time.y/6)))))*3))+1)/2).rrrr);
			...
			//Set the channel to the new color
				o.Normal = Normal_Map2Normals_Sample1.rgb;

		//Generate Layer: Normal Map3
			//Sample parts of the layer:
				half4 Normal_Map3Normals_Sample1 = tex2D(_SSSSmall_Ripples_Texture,((((uv_SSSSmall_Ripples_Texture.xy+float2(0,_Time.y/6))))));
			...
			//Blend the layer into the channel using the Normals Mix blend mode
				o.Normal = normalize(float3(Normal_Map3Normals_Sample1.rgb.xy+o.Normal.xy,Normal_Map3Normals_Sample1.rgb.z));

	//Generate layers for the Alpha channel.
		//Generate Layer: Alpha
			//Sample parts of the layer:
				half4 AlphaAlpha_Sample1 = (LinearEyeDepth(tex2D(_CameraDepthTexture, ((((IN.screenPos.xyw)).xy))).r).rrrr);

			//Set the channel to the new color
				o.Alpha = AlphaAlpha_Sample1.r;

		//Generate Layer: Alpha2
			//Sample parts of the layer:
				half4 Alpha2Alpha_Sample1 = float4(((((IN.screenPos.xyw)))),1);
...
BeginShaderInput
Type #! 1 #^ CC0 #?Type
VisName #! Underwater Color #^ CC0 #?VisName
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Water Density #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 0.89 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 15 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
InEditor #! 1 #^ CC0 #?InEditor
NormalMap #! 0 #^ CC0 #?NormalMap
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Large Ripples Scale #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 4.4 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Normal Map2 - Z Offset #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 70.1401 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
...
BeginShaderInput
Type #! 0 #^ CC0 #?Type
VisName #! Small Ripples Texture #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
...
EndShaderInput
ShaderName #! Shader Sandwich/Specific/Edge Faded Water #^ CC0 #?ShaderName
...
Spec Hardness #! 0.95 #^ CC0 #?Spec Hardness
...
LayerListName #! Ambient 2 2 #^ CC0 #?LayerListName
Is Mask #! True #^ CC0 #?Is Mask
...
LayerListName #! Ambient 2 #^ CC0 #?LayerListName
Is Mask #! True #^ CC0 #?Is Mask
Is Lighting #! True #^ CC0 #?Is Lighting
EndTag #! rgb #^ CC0 #?EndTag
EndShaderLayerList
...
Main Color #! 0.627451,0.8,0.8823529,1 #^ CC0 #^ 0 #?Main Color
...
Noise C #! False #^ CC0 #?Noise C
Light Data #! 0 #^ CC0 #?Light Data
Special Type #! 1 #^ CC0 #?Special Type
Linearize Depth #! True #^ CC0 #?Linearize Depth
UV Map #! 6 #^ CC0 #?UV Map
Map Local #! False #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 1 #^ CC0 #?Mix Amount
...
Vertex Mask #! 2 #^ CC0 #?Vertex Mask
BeginShaderEffect
TypeS #! SSESwizzle #^ CC0 #?TypeS
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 1 #^ CC0 #?UseAlpha
Channel R #! 2 #^ CC0 #?Channel R
Channel G #! 2 #^ CC0 #?Channel G
Channel B #! 2 #^ CC0 #?Channel B
Channel A #! 2 #^ CC0 #?Channel A
EndShaderEffect
EndShaderLayer
BeginShaderLayer
...
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.7426471,0.7426471,0.7426471,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
EndTag #! rgb #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Normal Map2 #^ CC0 #?Layer Name
...
Scale #! 4.4 #^ CC0 #^ 2 #?Scale
Y Scale #! 4.4 #^ CC0 #^ 2 #?Y Scale
Z Scale #! 4.4 #^ CC0 #^ 2 #?Z Scale
EndShaderEffect
BeginShaderEffect
...
Z Offset #! 70.1401 #^ CC0 #^ 3 #?Z Offset
EndShaderEffect
EndShaderLayer
BeginShaderLayer
Layer Name #! Normal Map3 #^ CC0 #?Layer Name
Layer Type #! 3 #^ CC0 #?Layer Type
Main Color #! 0,0,1,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #! fb6566c21f717904f83743a5a76dd0b0     #^ CC0 #^ 4 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
Noise Dimensions #! 0 #^ CC0 #?Noise Dimensions
Noise A #! 0 #^ CC0 #?Noise A
...
UseAlpha #! 0 #^ CC0 #?UseAlpha
X Offset #! 0 #^ CC0 #?X Offset
Y Offset #! 70.1401 #^ CC0 #^ 3 #?Y Offset
