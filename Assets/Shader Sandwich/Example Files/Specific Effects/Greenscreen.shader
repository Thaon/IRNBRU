...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the Alpha channel.
		//Generate Layer: Mask0 Copy
			//Sample parts of the layer:
				half4 Mask0_CopyAlpha_Sample1 = tex2D(_MainTex,(((uv_MainTex.xy))));
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: Texture3
			//Sample parts of the layer:
				half4 Texture3Diffuse_Sample1 = float4(0, 1, 0.213793, 1);

			//Blend the layer into the channel using the Subtract blend mode
				o.Albedo -= Texture3Diffuse_Sample1.rgb*_SSSGreen_Despill*Mask0;
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Green Despill #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
...
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/Specific/Greenscreen #^ CC0 #?ShaderName
...
Main Texture #! 97cb5aa7410455849856bd69630294aa    #^ CC0 #^ 0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
...
Main Color #! 0,1,0.213793,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
...
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
Add #! -0.28125 #^ CC0 #^ 2 #?Add
EndShaderEffect
BeginShaderEffect
TypeS #! SSEContrast #^ CC0 #?TypeS
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
Contrast #! 10.5 #^ CC0 #^ 3 #?Contrast
EndShaderEffect
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
