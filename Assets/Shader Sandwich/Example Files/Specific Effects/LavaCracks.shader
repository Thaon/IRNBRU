	...
	//Generate layers for the Parallax channel.
		//Generate Layer: Texture2 Copy
			//Sample parts of the layer:
				half4 Texture2_CopyHeight_Sample1 = tex2D(_MainTex,(((uv_MainTex.xy)))+((view*(depth)).xy));

			//Set the channel to the new color
				Height = Texture2_CopyHeight_Sample1.a;
...
IN.uvTexcoord.xy += view.xy*depth;
	...
	//Generate layers for the Normals channel.
		//Generate Layer: Texture2 Copy 2
			//Sample parts of the layer:
				half4 Texture2_Copy_2Normals_Sample2 = tex2D(_MainTex,(((uv_MainTex.xy)) + float2(0.01071429, 0)));
				half4 Texture2_Copy_2Normals_Sample3 = tex2D(_MainTex,(((uv_MainTex.xy)) + float2(0, 0.01071429)));
				half4 Texture2_Copy_2Normals_Sample1 = tex2D(_MainTex,(((uv_MainTex.xy))));

			//Apply Effects:
				Texture2_Copy_2Normals_Sample1 = (float4(((Texture2_Copy_2Normals_Sample1.a-Texture2_Copy_2Normals_Sample2.a)*1.214286),((Texture2_Copy_2Normals_Sample1.a-Texture2_Copy_2Normals_Sample3.a)*1.214286),1,Texture2_Copy_2Normals_Sample1.a));

			//Set the channel to the new color
				o.Normal = Texture2_Copy_2Normals_Sample1.rgb;

	//Generate layers for the Diffuse channel.
		//Generate Layer: Texture2
			//Sample parts of the layer:
				half4 Texture2Diffuse_Sample1 = tex2D(_MainTex,(((uv_MainTex.xy))));
	...
	//Generate layers for the Emission channel.
		//Generate Layer: Texture2 Copy 2 2
			//Sample parts of the layer:
				half4 Texture2_Copy_2_2Emission_Sample1 = tex2D(_MainTex,(((uv_MainTex.xy))));
			...
			//Blend the layer into the channel using the Mix blend mode
				Emission = lerp(Emission,Texture2_Copy_2_2Emission_Sample1.rgba,Texture2_Copy_2_2Emission_Sample1.a);

		//Generate Layer: Emission
			//Sample parts of the layer:
				half4 EmissionEmission_Sample1 = (float(NoiseB2D((((((IN.uvTexcoord.xy+float2(_Time.y,0)))))*3))).rrrr);
			...
			//Blend the layer into the channel using the Multiply blend mode
				Emission *= EmissionEmission_Sample1.rgba;
	...
	//Generate layers for the Gloss channel.
		//Generate Layer: Specular2
			...
			//Set the channel to the new color
				o.Specular = Specular2Specular_Sample1.rgb;
...
BeginShaderInput
Type #! 0 #^ CC0 #?Type
VisName #! Base (RGBA) #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #! aeea31ea334e78d41bfa85dfd0ed1a28 #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Scroll #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 464.2552 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/Tutorials/Lava Cracks #^ CC0 #?ShaderName
...
Spec Hardness #! 0.4930869 #^ CC0 #?Spec Hardness
...
Parallax Height #! 0.1325905 #^ CC0 #^ 1 #?Parallax Height
...
Main Texture #! aeea31ea334e78d41bfa85dfd0ed1a28   #^ CC0 #^ 0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
...
EndTag #! rgb #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Specular2 #^ CC0 #?Layer Name
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.2205882,0.2205882,0.2205882,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
...
EndTag #! rgb #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Texture2 Copy 2 #^ CC0 #?Layer Name
Layer Type #! 3 #^ CC0 #?Layer Type
Main Color #! 0.627451,0.8,0.8823529,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #! aeea31ea334e78d41bfa85dfd0ed1a28  #^ CC0 #^ 0 #?Main Texture
...
Size #! 0.01071429 #^ CC0 #?Size
Height #! 1.214286 #^ CC0 #?Height
...
BeginShaderLayer
Layer Name #! Texture2 Copy 2 2 #^ CC0 #?Layer Name
Layer Type #! 3 #^ CC0 #?Layer Type
Main Color #! 0.627451,0.8,0.8823529,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #! aeea31ea334e78d41bfa85dfd0ed1a28  #^ CC0 #^ 0 #?Main Texture
...
X Offset #! 464.2552 #^ CC0 #^ 2 #?X Offset
...
EndTag #! a #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Texture2 Copy #^ CC0 #?Layer Name
Layer Type #! 3 #^ CC0 #?Layer Type
Main Color #! 0.627451,0.8,0.8823529,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #! aeea31ea334e78d41bfa85dfd0ed1a28      #^ CC0 #^ 0 #?Main Texture
