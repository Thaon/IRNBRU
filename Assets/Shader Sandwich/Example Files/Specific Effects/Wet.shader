...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the Normals channel.
		//Generate Layer: Normal Map Copy Copy
			//Sample parts of the layer:
				half4 Normal_Map_Copy_CopyNormals_Sample2 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale)),0)+float3(0,0,_Time.z)))) + float3(0.048, 0, 0))*3))+1)/2).rrrr);
				half4 Normal_Map_Copy_CopyNormals_Sample3 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale)),0)+float3(0,0,_Time.z)))) + float3(0, 0.048, 0))*3))+1)/2).rrrr);
				half4 Normal_Map_Copy_CopyNormals_Sample1 = (float((Noise3D((((((float3((IN.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale)),0)+float3(0,0,_Time.z)))))*3))+1)/2).rrrr);

			//Apply Effects:
				Normal_Map_Copy_CopyNormals_Sample1 = (float4(((Normal_Map_Copy_CopyNormals_Sample1.r-Normal_Map_Copy_CopyNormals_Sample2.r)*_SSSRain_Strength),((Normal_Map_Copy_CopyNormals_Sample1.r-Normal_Map_Copy_CopyNormals_Sample3.r)*_SSSRain_Strength),1,Normal_Map_Copy_CopyNormals_Sample1.a));

			//Set the channel to the new color
				o.Normal = Normal_Map_Copy_CopyNormals_Sample1.rgb;
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: Specular Copy
			//Sample parts of the layer:
				half4 Specular_CopyDiffuse_Sample1 = (float((Noise2D((((((IN.uvTexcoord.xy*float2(_SSSPuddle_Sizes,_SSSPuddle_Sizes)))))*3))+1)/2).rrrr);

			//Apply Effects:
				Specular_CopyDiffuse_Sample1.rgb = lerp(float3(0.5,0.5,0.5),Specular_CopyDiffuse_Sample1.rgb,_SSSPuddle_Contrast);
				Specular_CopyDiffuse_Sample1.rgb = clamp(Specular_CopyDiffuse_Sample1.rgb,0,1);
				Specular_CopyDiffuse_Sample1.rgb = (float3(1,1,1)-Specular_CopyDiffuse_Sample1.rgb);

			//Blend the layer into the channel using the Multiply blend mode
				o.Albedo = lerp(o.Albedo,o.Albedo*Specular_CopyDiffuse_Sample1.rgb,_SSSPuddle_Darkening);
	...
	//Generate layers for the Gloss channel.
		//Generate Layer: Specular 2
			...
			//Set the channel to the new color
				o.Specular = Specular_2Specular_Sample1.rgb;

		//Generate Layer: Specular
			//Sample parts of the layer:
				half4 SpecularSpecular_Sample1 = (float((Noise2D((((((IN.uvTexcoord.xy*float2(_SSSPuddle_Sizes,_SSSPuddle_Sizes)))))*3))+1)/2).rrrr);
...
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.6544118,0.6544118,0.6544118,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Rain Scale #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 70 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Normal Map - Z Offset #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 983.4214 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 2 #^ CC0 #?SpecialType
InEditor #! 0 #^ CC0 #?InEditor
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Rain Strength #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Puddle Sizes #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Puddle Contrast #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 1.46875 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 3 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Puddle Darkening #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
...
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/Specific/Wet Ground #^ CC0 #?ShaderName
...
Spec Hardness #! 0.3 #^ CC0 #^ 1 #?Spec Hardness
...
EndShaderLayer
BeginShaderLayer
Layer Name #! Specular Copy #^ CC0 #?Layer Name
Layer Type #! 5 #^ CC0 #?Layer Type
Main Color #! 0.3,0.3,0.3,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
...
Scale #! 2 #^ CC0 #^ 6 #?Scale
Y Scale #! 2 #^ CC0 #^ 6 #?Y Scale
Z Scale #! 2 #^ CC0 #^ 6 #?Z Scale
EndShaderEffect
BeginShaderEffect
TypeS #! SSEContrast #^ CC0 #?TypeS
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
Contrast #! 1.46875 #^ CC0 #^ 7 #?Contrast
EndShaderEffect
BeginShaderEffect
...
EndTag #! rgb #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Specular 2 #^ CC0 #?Layer Name
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.6544118,0.6544118,0.6544118,1 #^ CC0 #^ 2 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
EndTag #! rgb #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Normal Map Copy Copy #^ CC0 #?Layer Name
Layer Type #! 5 #^ CC0 #?Layer Type
...
UseAlpha #! 0 #^ CC0 #?UseAlpha
Seperate #! False #^ CC0 #?Seperate
Scale #! 70 #^ CC0 #^ 3 #?Scale
Y Scale #! 70 #^ CC0 #^ 3 #?Y Scale
Z Scale #! 70 #^ CC0 #^ 3 #?Z Scale
EndShaderEffect
BeginShaderEffect
...
Z Offset #! 983.4214 #^ CC0 #^ 4 #?Z Offset
EndShaderEffect
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
