...
Properties {
	...
	_SSSDistance ("Distance", Float) = 2.810000000
...
//Make our inputs accessible by declaring them here.
 ...
 //Set up Unity Surface Shader Settings.
	#pragma surface frag_surf CLStandard addshadow  fullforwardshadows
...
half4 LightingCLStandard (CSurfaceOutput s, half3 lightDir, half3 viewDir, half atten) {
	...
	half NdotL = lerp(max (0, dot (s.Normal, lightDir)),1,_SSSWax_Level); //Calculate the dot of the faces normal and the lights direction. This means a lower number the further the angle of the face is from the light source. Finally, we blend this with the default value of 1 (Due to no normals being turned up)
	half4 c;
...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the Emission channel.
		//Generate Layer: Scattering
			//Sample parts of the layer:
				half4 ScatteringEmission_Sample1 = float4((((mul(_World2Object, float4(IN.worldPos,1)).xyz))),1);
			...
			//Blend the layer into the channel using the Add blend mode
				Emission += ScatteringEmission_Sample1.rgba*_SSSWax_Level;
...
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.5588235,0.4457553,0.3246107,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Distance #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 2.81 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Falloff #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 4.06 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Wax Level #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 0.3917526 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/Specific/Simple Wax #^ CC0 #?ShaderName
...
Use Normals #! 0.3917526 #^ CC0 #^ 4 #?Use Normals
Specular On #! False #^ CC0 #?Specular On
Specular Type #! 0 #^ CC0 #?Specular Type
Spec Hardness #! 0.1188621 #^ CC0 #?Spec Hardness
...
Emission Type #! 1 #^ CC0 #?Emission Type
...
Main Color #! 0.5588235,0.4457553,0.3246107,1 #^ CC0 #^ 0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
...
BeginShaderLayer
Layer Name #! Scattering #^ CC0 #?Layer Name
...
Linearize Depth #! False #^ CC0 #?Linearize Depth
UV Map #! 7 #^ CC0 #?UV Map
Map Local #! True #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 0.3917526 #^ CC0 #^ 4 #?Mix Amount
Use Fadeout #! False #^ CC0 #?Use Fadeout
Fadeout Limit Min #! 0 #^ CC0 #?Fadeout Limit Min
Fadeout Limit Max #! 10 #^ CC0 #?Fadeout Limit Max
Fadeout Start #! 3 #^ CC0 #?Fadeout Start
...
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
Power #! 4.06 #^ CC0 #^ 3 #?Power
EndShaderEffect
BeginShaderEffect
TypeS #! SSEMathMul #^ CC0 #?TypeS
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
Multiply #! 2.81 #^ CC0 #^ 2 #?Multiply
EndShaderEffect
BeginShaderEffect
