	...
	//Generate layers for the Mask0 channel.
		...
		//Generate Layer: Mask02
			...
			//Blend the layer into the channel using the Mix blend mode
				Mask0 = lerp(Mask0,Mask02Mask0_Sample1.r,SSShellDepth);

	//Generate layers for the Vertex channel.
		//Generate Layer: Vertex
			//Sample parts of the layer:
				half4 VertexVertex_Sample1 = (float(NoiseB2D(((((((v.texcoord.xyz.xy+float2(_Time.y/2,0))*float2(_SSSWave_Scale,_SSSWave_Scale)))))*3))).rrrr);
...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: Color
			...
			//Apply Effects:
				ColorDiffuse_Sample1.rgb = lerp(float3(0.5,0.5,0.5),ColorDiffuse_Sample1.rgb,1.857143);
...
float4 vert(appdata_base v) : POSITION {
	...
	v.vertex.xyz += v.normal*(_ShellDistance*pow(1,1.022989));
...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the Diffuse channel.
		//Generate Layer: Texture
			//Sample parts of the layer:
				half4 TextureShellDiffuse_Sample1 = lerp(float4(0, 0, 0, 1), _SSSOutline_Color, ((((1-dot(o.Normal, IN.viewDir))))));

			//Apply Effects:
				TextureShellDiffuse_Sample1.rgb = pow(TextureShellDiffuse_Sample1.rgb,_SSSRim_Thinness);

			//Set the channel to the new color
				o.Albedo = TextureShellDiffuse_Sample1.rgb;
...
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.4779412,0.4779412,0.4779412,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 1 #^ CC0 #?Type
VisName #! Outline Color #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 1,0.6685237,0,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Outline Distance #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0,0,0,0 #^ CC0 #?Color
Number #! 0.03869732 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Rim Thinness #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0,0,0,0 #^ CC0 #?Color
Number #! 2.68 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Wave Strength #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0,0,0,0 #^ CC0 #?Color
Number #! 0.02066116 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Wave Scale #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0,0,0,0 #^ CC0 #?Color
Number #! 5.92 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Mask02 - Mix Amount #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0,0,0,0 #^ CC0 #?Color
...
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/Simple/Selection #^ CC0 #?ShaderName
...
Shells Distance #! 0.03869732 #^ CC0 #^ 3 #?Shells Distance
Shell Ease #! 1.022989 #^ CC0 #?Shell Ease
...
Shells ZWrite #! False #^ CC0 #?Shells ZWrite
Shells Use Transparency #! True #^ CC0 #?Shells Use Transparency
Shell Blend Mode #! 1 #^ CC0 #?Shell Blend Mode
Shells Transparency #! 1 #^ CC0 #?Shells Transparency
Shell Lighting #! False #^ CC0 #?Shell Lighting
...
EndShaderLayer
BeginShaderLayer
Layer Name #! Mask02 #^ CC0 #?Layer Name
Layer Type #! 0 #^ CC0 #?Layer Type
...
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.4779412,0.4779412,0.4779412,1 #^ CC0 #^ 0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
Contrast #! 1.857143 #^ CC0 #?Contrast
EndShaderEffect
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
...
Main Color #! 1,0.6685237,0,1 #^ CC0 #^ 2 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
Map Local #! False #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 0.02066116 #^ CC0 #^ 5 #?Mix Amount
Use Fadeout #! False #^ CC0 #?Use Fadeout
Fadeout Limit Min #! 0 #^ CC0 #?Fadeout Limit Min
Fadeout Limit Max #! 10 #^ CC0 #?Fadeout Limit Max
Fadeout Start #! 3 #^ CC0 #?Fadeout Start
...
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
X Offset #! 181.1809 #^ CC0 #^ 8 #?X Offset
...
Scale #! 5.92 #^ CC0 #^ 6 #?Scale
Y Scale #! 5.92 #^ CC0 #^ 6 #?Y Scale
Z Scale #! 5.92 #^ CC0 #^ 6 #?Z Scale
EndShaderEffect
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
