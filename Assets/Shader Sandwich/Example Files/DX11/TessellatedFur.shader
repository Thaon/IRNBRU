...
Properties {
	...
	_SSSGrass_Scale ("Grass Scale", Float) = 100.000000000
...
//Make our inputs accessible by declaring them here.
 ...
 //Set up Unity Surface Shader Settings.
	#pragma surface frag_surf CLPBR_Standard vertex:vert  addshadow  interpolateview noshadow tessellate:tess
...
//Create a struct for the inputs of the vertex shader which includes whatever Shader Sandwich might need.
	...
	#endif
	fixed4 color : COLOR;
};		float4 tess (appdata_min v0, appdata_min v1, appdata_min v2)
		{
...
void vert (inout appdata_min v) {
	...
	//Generate layers for the GrassDisp channel.
		//Generate Layer: Vertex Copy
			//Sample parts of the layer:
				half4 Vertex_CopyMask0_Sample1 = (float((Noise2D((((((v.texcoord.xyz.xy*float2(_SSSGrass_Scale,_SSSGrass_Scale)))))*3))+1)/2).rrrr);
	...
	//Generate layers for the WindDisp channel.
		//Generate Layer: Vertex2 Copy
			//Sample parts of the layer:
				half4 Vertex2_CopyMask1_Sample1 = (float((Noise2D(((((((v.texcoord.xyz.xy*float2(_SSSWind_Scale,_SSSWind_Scale))+float2(_Time.y/2,0)))))*3))+1)/2).rrrr);
...
void frag_surf (Input IN, inout CSurfaceOutput o) {
	...
	//Generate layers for the GrassDisp channel.
		//Generate Layer: Vertex Copy
			//Sample parts of the layer:
				half4 Vertex_CopyMask0_Sample1 = (float((Noise2D((((((IN.uvTexcoord.xy*float2(_SSSGrass_Scale,_SSSGrass_Scale)))))*3))+1)/2).rrrr);
	...
	//Generate layers for the WindDisp channel.
		//Generate Layer: Vertex2 Copy
			//Sample parts of the layer:
				half4 Vertex2_CopyMask1_Sample1 = (float((Noise2D(((((((IN.uvTexcoord.xy*float2(_SSSWind_Scale,_SSSWind_Scale))+float2(_Time.y/2,0)))))*3))+1)/2).rrrr);
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: AO
			//Sample parts of the layer:
				half4 AODiffuse_Sample1 = (float((Noise2D((((((IN.uvTexcoord.xy*float2(_SSSGrass_Scale,_SSSGrass_Scale)))))*3))+1)/2).rrrr);

			//Blend the layer into the channel using the Multiply blend mode
				o.Albedo = lerp(o.Albedo,o.Albedo*AODiffuse_Sample1.rgb,_SSSAO_Strength);
...
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.5614604,1,0.3088235,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! AO Strength #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 0.5413223 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Grass Height #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 0.1960227 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Grass Scale #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 100 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Grass Quality (Tessellation) #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 50 #^ CC0 #?Number
Range0 #! 1 #^ CC0 #?Range0
Range1 #! 50 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
InEditor #! 1 #^ CC0 #?InEditor
NormalMap #! 0 #^ CC0 #?NormalMap
...
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.125,0.125,0.125,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
...
BeginShaderInput
Type #! 4 #^ CC0 #?Type
VisName #! Wind Strength #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 0.08264463 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 0 #^ CC0 #?SpecialType
...
BeginShaderInput
Type #! 1 #^ CC0 #?Type
VisName #! Wind Direction #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.1617647,0,0.1617647,1 #^ CC0 #?Color
Number #! 0 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
...
BeginShaderInput
Type #! 3 #^ CC0 #?Type
VisName #! Wind Offset #^ CC0 #?VisName
ImageDefault #! 0 #^ CC0 #?ImageDefault
Image #!  #^ CC0 #?Image
Cube #!  #^ CC0 #?Cube
Color #! 0.8,0.8,0.8,1 #^ CC0 #?Color
Number #! 133.2589 #^ CC0 #?Number
Range0 #! 0 #^ CC0 #?Range0
Range1 #! 1 #^ CC0 #?Range1
MainType #! 0 #^ CC0 #?MainType
SpecialType #! 3 #^ CC0 #?SpecialType
InEditor #! 0 #^ CC0 #?InEditor
NormalMap #! 0 #^ CC0 #?NormalMap
EndShaderInput
ShaderName #! Shader Sandwich/DX11/Tessellated Fur #^ CC0 #?ShaderName
Hard Mode #! True #^ CC0 #?Hard Mode
Tech Lod #! 200 #^ CC0 #?Tech Lod
Cull #! 1 #^ CC0 #?Cull
Tech Shader Target #! 5 #^ CC0 #?Tech Shader Target
...
Shadows #! False #^ CC0 #?Shadows
Interpolate View #! True #^ CC0 #?Interpolate View
...
Spec Hardness #! 0.2629603 #^ CC0 #^ 6 #?Spec Hardness
...
Tessellation On #! True #^ CC0 #?Tessellation On
Tessellation Type #! 2 #^ CC0 #?Tessellation Type
Tessellation Quality #! 50 #^ CC0 #^ 5 #?Tessellation Quality
...
LayerListName #! GrassDisp #^ CC0 #?LayerListName
Is Mask #! True #^ CC0 #?Is Mask
Is Lighting #! False #^ CC0 #?Is Lighting
EndTag #! r #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Vertex Copy #^ CC0 #?Layer Name
...
Scale #! 100 #^ CC0 #^ 4 #?Scale
Y Scale #! 100 #^ CC0 #^ 4 #?Y Scale
Z Scale #! 100 #^ CC0 #^ 4 #?Z Scale
EndShaderEffect
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
LayerListUniqueName #! Mask1 #^ CC0 #?LayerListUniqueName
LayerListName #! WindDisp #^ CC0 #?LayerListName
Is Mask #! True #^ CC0 #?Is Mask
Is Lighting #! False #^ CC0 #?Is Lighting
EndTag #! r #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! Vertex2 Copy #^ CC0 #?Layer Name
Layer Type #! 5 #^ CC0 #?Layer Type
Main Color #! 0.1617647,0,0.1617647,1 #^ CC0 #^ 9 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
UseAlpha #! 0 #^ CC0 #?UseAlpha
Seperate #! False #^ CC0 #?Seperate
Scale #! 55.7 #^ CC0 #^ 10 #?Scale
Y Scale #! 55.7 #^ CC0 #^ 10 #?Y Scale
Z Scale #! 55.7 #^ CC0 #^ 10 #?Z Scale
EndShaderEffect
BeginShaderEffect
TypeS #! SSEUVOffset #^ CC0 #?TypeS
IsVisible #! True #^ CC0 #?IsVisible
UseAlpha #! 0 #^ CC0 #?UseAlpha
X Offset #! 133.2589 #^ CC0 #^ 11 #?X Offset
...
Main Color #! 0.5614604,1,0.3088235,1 #^ CC0 #^ 1 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
Map Local #! False #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 0.5413223 #^ CC0 #^ 2 #?Mix Amount
Use Fadeout #! False #^ CC0 #?Use Fadeout
Fadeout Limit Min #! 0 #^ CC0 #?Fadeout Limit Min
Fadeout Limit Max #! 10 #^ CC0 #?Fadeout Limit Max
Fadeout Start #! 3 #^ CC0 #?Fadeout Start
...
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.125,0.125,0.125,1 #^ CC0 #^ 7 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
Cubemap #!  #^ CC0 #?Cubemap
Noise Type #! 0 #^ CC0 #?Noise Type
...
EndTag #! rgba #^ CC0 #?EndTag
BeginShaderLayer
Layer Name #! GrassDisp #^ CC0 #?Layer Name
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 1,1,1,1 #^ CC0 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
...
Map Local #! False #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 0.1960227 #^ CC0 #^ 3 #?Mix Amount
Use Fadeout #! False #^ CC0 #?Use Fadeout
Fadeout Limit Min #! 0 #^ CC0 #?Fadeout Limit Min
Fadeout Limit Max #! 10 #^ CC0 #?Fadeout Limit Max
Fadeout Start #! 3 #^ CC0 #?Fadeout Start
...
EndShaderLayer
BeginShaderLayer
Layer Name #! WindDisp #^ CC0 #?Layer Name
Layer Type #! 0 #^ CC0 #?Layer Type
Main Color #! 0.1617647,0,0.1617647,1 #^ CC0 #^ 9 #?Main Color
Second Color #! 0,0,0,1 #^ CC0 #?Second Color
Main Texture #!  #^ CC0 #?Main Texture
...
Map Local #! False #^ CC0 #?Map Local
Use Alpha #! False #^ CC0 #?Use Alpha
Mix Amount #! 0.08264463 #^ CC0 #^ 8 #?Mix Amount
Use Fadeout #! False #^ CC0 #?Use Fadeout
Fadeout Limit Min #! 0 #^ CC0 #?Fadeout Limit Min
Fadeout Limit Max #! 10 #^ CC0 #?Fadeout Limit Max
Fadeout Start #! 3 #^ CC0 #?Fadeout Start
