...
public class SSEMathPow : ShaderEffect{
	...
	public static ShaderColor Preview(ShaderEffect SE,ShaderColor OldColor){
		ShaderColor NewColor = new ShaderColor(Mathf.Pow(OldColor.r,SE.Inputs[0].Float),Mathf.Pow(OldColor.g,SE.Inputs[0].Float),Mathf.Pow(OldColor.b,SE.Inputs[0].Float),Mathf.Pow(OldColor.a,SE.Inputs[0].Float));
		return NewColor;
	}
}
